...
class ApiKey {
    ...
    public function get_api_key( $request ) {
        ...
        $example_option = get_option( 'amzw_api_key' );
    ...
    public function update_api_key( $request ) {
        ...
        $updated = update_option( 'amzw_api_key', sanitize_text_field($request->get_param( 'api_key' )) );
        $this->amz_cron_function();
        $this->amz_cron_site_function();
        $this->amz_cron_all_job_function();
        $this->amz_cron_specific_job_details();
    ...
    public function delete_api_key( $request ) {
        ...
        $deleted = delete_option( 'amzw_api_key' );

        $this->empty_amz_database_tables();
    ...
    public function empty_amz_database_tables(){
       global $wpdb;
       $tableArray = [
